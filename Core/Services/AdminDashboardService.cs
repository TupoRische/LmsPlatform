...
namespace Core.Services
{
    ...
    GetRandomStudentsAsync(int count = 3)
        ...
        public async Task<IEnumerable<PendingTeacherVm>>
        GetPendingTeachersPreviewAsync(int count = 3)
        {
            return userManager.Users
                .Where(u => u.RequestedTeacher && !u.IsApproved)
                .OrderByDescending(u => u.CreatedOn)   // най-новите първо
                .Take(count)
        ...
        public async Task<IEnumerable<RandomSchoolVm>>
        GetRandomSchoolsAsync(int count = 3)
        {
